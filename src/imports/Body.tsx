import svgPaths from "./svg-xrqm5iym2i";
...
export default function Body() {
  return (
    <div className="bg-[#0b0b16] border-0 border-[#262626] border-solid relative size-full" data-name="body">
      <div className="absolute bg-black border-0 border-[#262626] border-solid h-[978px] left-0 top-0 w-[1440px]" data-name="div">
        <div className="absolute bg-[rgba(0,0,0,0)] border-0 border-[#262626] border-solid h-[914px] left-[496px] top-[98px] w-[448px]" data-name="div">
          <div className="absolute bg-[rgba(0,0,0,0)] content-stretch flex flex-col gap-[8px] items-center left-0 px-[101px] top-0 w-[448px]" data-name="div">
            <div aria-hidden="true" className="absolute border-0 border-[#262626] border-solid inset-0 pointer-events-none" />
            <p className="font-['Pretendard:SemiBold',sans-serif] leading-[1.3] not-italic relative shrink-0 text-[36px] text-center text-white w-full whitespace-pre-wrap">회원가입</p>
            <p className="font-['Pretendard:Regular',sans-serif] h-[16px] leading-[normal] not-italic relative shrink-0 text-[13px] text-[rgba(255,255,255,0.6)] text-center w-full whitespace-pre-wrap">새 계정을 만들어 ScreenFlow를 시작하세요</p>
          </div>
          <div className="absolute bg-[rgba(17,24,39,0.5)] content-stretch flex flex-col gap-[25px] items-start left-0 p-[25px] rounded-[12px] top-[96px] w-[448px]" data-name="div">
            ...
            <div className="bg-[rgba(0,0,0,0)] content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full" data-name="form">
              <div aria-hidden="true" className="absolute border-0 border-[#262626] border-solid inset-0 pointer-events-none" />
              <InputFieldWithLink>
                <LabelText text="이메일" />
                <Input>
              ...
              <InputFieldWithLink>
                <LabelText text="비밀번호 확인" />
                <Input>
                  <LinkText text="비밀번호를 다시 입력하세요" />
                  <div className="content-stretch flex flex-[1_0_0] h-[22px] items-center min-h-px min-w-px" data-name="Content" />
                </Input>
              </InputFieldWithLink>
              <InputFieldWithLink>
                <LabelText text="생년월일(선택사항)" />
                <Input>
                  <LinkText text="dd.mm.yyyy" />
                  <div className="content-stretch flex flex-[1_0_0] h-[22px] items-center min-h-px min-w-px" data-name="Content" />
                </Input>
              </InputFieldWithLink>
              <InputFieldWithLink>
                <LabelText text="주소(선택사항)" />
                <Input>
                  <LinkText text="서울특별시 강남구" />
                  <div className="content-stretch flex flex-[1_0_0] h-[22px] items-center min-h-px min-w-px" data-name="Content" />
                </Input>
              </InputFieldWithLink>
          ...
          <div className="absolute bg-[rgba(0,0,0,0)] border-0 border-[#262626] border-solid font-['Pretendard:Regular',sans-serif] h-[48px] left-0 not-italic text-[14px] text-center top-[814px] w-[448px] whitespace-pre-wrap" data-name="div">
            <p className="-translate-x-1/2 absolute font-['Inter:Regular',sans-serif] font-normal h-[16px] leading-[0] left-[224.2px] text-[0px] text-black top-[2px] w-[175px]">
              <span className="leading-[14px] text-[#9ca3af]">이미 계정이 있으신가요?</span>
              <span className="leading-[14px] text-[#6c79ff]">{` 로그인`}</span>
            </p>
